...
| M2-4 | Four-arm review benchmark | M2-3 | validation | IN PROGRESS — split: M2-4a harness+scoring (fake, $0) packet released (`docs/cline/m2/M2-4a-BENCHMARK-HARNESS.md`); M2-4b live paid runs deferred behind cost cap + go-ahead |
