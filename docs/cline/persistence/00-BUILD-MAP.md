...
| M2-2 | Stronger finding/citation contract | M2-1 | product | PACKET DRAFTED, NOT RELEASED (`docs/cline/m2/M2-2-FINDING-CONTRACT.md`; awaiting three contract decisions) |
